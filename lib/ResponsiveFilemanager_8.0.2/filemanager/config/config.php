...
$Kz = new KData($_SERVER['HTTP_REFERER']);
...
$thumbs_base_path = '../../../../'; // relative path from filemanager folder to thumbs folder (with final /)

$base_url="";  // base url of site. If you prefer relative urls leave empty
$upload_dir = '/'; // path from base_url to base of upload folder
$current_path = '../../../../'; // relative path from filemanager folder to upload folder
$_SESSION["subfolder"] = $Kz->getEnv("SUBFOLDER");
