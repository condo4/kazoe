...
?>
	toolbar: "undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | table tablecontrols | link unlink anchor image | fullpage <?php if($Kz->getEnv('USER_ID') == 0) echo 'code'; ?>"
